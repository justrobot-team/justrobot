...
class Channel:
    ...
    Methods:
        load: Pass built method for quick build
        get_icon: Get channel icon(guild icon instand if none)
        get_banners: Get channel banners(guild banners instand if none)
...
class Guild:
    ...
    Methods:
        ...
        get_banners: Get guild banners(guild icon instand if none)
