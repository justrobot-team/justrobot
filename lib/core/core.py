...
class Core:
    ...
    def pickUser(
        ...
        """
        中文:
        获取用户对象，当传入适配器名称时返回单个实例，为传入时返回存有所有匹配结果的列表。
        :param uid: 用户 ID。
        :param adapter_name: 适配器名称。
        :return: 用户对象。

        English:
        Get the user object, return a single instance when the adapter name is passed in,
        and return a list containing all matching results when it is not passed in.
        :param uid: User ID.
        :param adapter_name: The adapter name.
    ...
    def pickGroup(
        ...
        """
        中文:
        获取群组对象，当传入适配器名称时返回单个实例，为传入时返回存有所有匹配结果的列表。
        :param grid: 群组 ID。
        :param adapter_name: 适配器名称。
        :return: 群组对象。

        English:
        Get the group object, return a single instance when the adapter name is passed in,
        and return a list containing all matching results when it is not passed in.
        :param grid: Group ID.
        :param adapter_name: The adapter name.
    ...
    def pickChannel(
        ...
        """
        中文:
        获取频道对象，当传入适配器名称时返回单个实例，为传入时返回存有所有匹配结果的列表。
        :param cid: 频道 ID。
        :param guid: 公会 ID。
        :param adapter_name: 适配器名称。
        :return: 频道对象。
        ...
        English:
        Get the channel object, return a single instance when the adapter name is passed in,
        and return a list containing all matching results when it is not passed in.
    ...
    def pickGuild(
        ...
        """
        中文:
        获取公会对象，当传入适配器名称时返回单个实例，为传入时返回存有所有匹配结果的列表。
        :param guid: 公会 ID。
        :param adapter_name: 适配器名称。
        :return: 公会对象。

        English:
        Get the guild object, return a single instance when the adapter name is passed in,
        and return a list containing all matching results when it is not passed in.
        :param guid: Guild ID.
        :param adapter_name: The adapter name.
    ...
    async def set_user_list(
        ...
        if isinstance(uid, list):
            ...
            if not (uid[0] in self.adapter_name_list):
                return await _error(
                    [
